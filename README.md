...
ALGORITHM:
step by step procedure to solve the problem so what is the difference between algorithm and program. Algorithms are written as design time and program is written at implementation time.
